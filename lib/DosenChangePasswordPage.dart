...
class DosenChangePasswordPage extends StatefulWidget {
  const DosenChangePasswordPage({super.key});

  @override
  _DosenChangePasswordPageState createState() =>
      _DosenChangePasswordPageState();
}

class _DosenChangePasswordPageState extends State<DosenChangePasswordPage> {
